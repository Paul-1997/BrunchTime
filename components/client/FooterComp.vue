<template>
  <footer class="bg-dark text-white py-6 text-center mt-auto">
    <p class="mb-3">本網站僅作為學習作品，不做商業用途使用</p>
    <div class="d-flex flex-column align-items-center">
      <!-- <img src="/public/logo-sm.png" alt="" width="60" /> -->
      <p class="fw-bold fs-sm mb-3">食晨已到© 2024 Copyright | Made by Paul.</p>
      <ul class="d-inline-flex gap-5 mb-3">
        <li class="social__icon cursor-pointer">
      ...
      <p class="mb-1">連絡電話: 02-12345678</p>
      <p class="mb-3">連絡信箱: BrunchTime@mail.com</p>
      <RouterLink
        to="/dashboard"
        class="text-decoration-underline text-hover-accent"
        style="text-underline-offset: 0.15em"
      >
        登入後台
      </RouterLink>
    </div>
